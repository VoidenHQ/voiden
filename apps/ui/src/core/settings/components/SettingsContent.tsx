...
export const SettingsContent = () => {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
        ...
        <div className="border border-border rounded-lg p-4 bg-surface">
          <div className="flex items-start justify-between">
            <div className="flex-1">
              <h3 className="font-medium">Block Overview</h3>
              <p className="text-sm text-muted-foreground mt-1">
                Show a collapsible outline panel beside the editor listing all blocks in the current .void file, grouped by request section.
              </p>
            </div>
            <div className="flex items-center gap-3 ml-4">
              <label className="relative inline-flex items-center cursor-pointer">
                <input
                  ...
                  onChange={(e) => save({ editor: { ...settings.editor, block_overview: e.target.checked } })}
      ...
      {/* Developer Mode */}
      <section className="mb-8">
        <h2 className="text-xl font-semibold mb-4">Developer Mode</h2>

        <div className="border border-border rounded-lg p-4 bg-surface">
          <div className="flex items-start justify-between">
            <div className="flex-1">
              <h3 className="font-medium">System Log</h3>
              <p className="text-sm text-muted-foreground mt-1">
                Show the System Log tab to inspect IPC calls, git operations, and state changes.
              </p>
            </div>
            <div className="flex items-center gap-3 ml-4">
              <label className="relative inline-flex items-center cursor-pointer">
                <input
                  ...
                  onChange={(e) => save({ developer: { system_log: e.target.checked } })}
                  className="sr-only peer"
                />
                <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
              </label>
